...
# -*- coding: utf-8 -*-
"""
Created on Tue Oct 20 20:13:01 2020
...
file=open('/Users/cgangoda/LunarProject/fy20_adc_data_file_88_degrees.csv','r')
...
n=7223207 #number of interpolation point for x and y axis
x_min=min(x)
x_max=max(x)
y_min=min(y)
y_max=max(y)
